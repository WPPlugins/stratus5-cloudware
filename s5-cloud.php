...
function s5form($atts, $content){
  ...
  <div id="s5-loading-gif" style="display:none;">
    ...
    <form id="auto-login-form-admin" method="post" action="<?php echo $_SESSION['post_url']; ?>j_spring_security_check">
      <input id="auto-login-form-admin-j_username" type="hidden" name="j_username" value="<?php echo $_SESSION['username']; ?>" />
      <input id="auto-login-form-admin-j_password" type="hidden" name="j_password" value="<?php echo $_SESSION['password']; ?>" />
    </form>
  ...
  <div class="wrap">
    ...
    <div class="adminwrapper">
      ...
      <?php    
        $showConnectButton = 0;
        $params = array(
          "j_username" => esc_attr( get_option('username') ),
          "j_password" => esc_attr( get_option('password') ),
          "_spring_security_remember_me" => "on"
        );
  
        $url = "https://".esc_attr( get_option('domainname') )."/j_spring_security_check";
